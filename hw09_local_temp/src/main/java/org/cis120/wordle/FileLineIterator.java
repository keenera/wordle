...
/**
 * This is FileLineIterator.java from the TwitterBot homework. This class is
 * used to read from & parse CSV files in order to initialize the set of
 * possible Wordle answers and the set of dictionary words a user could
 * possibly enter.
 */
